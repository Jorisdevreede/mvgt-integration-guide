...
- Use the globalPlatform2 flywheel as the primary case study — a real, production-grade orchestrator that completed the MVGT flow
...
**Acceptance criteria:**
- Case study covers a real system (globalPlatform2 flywheel)
...
| Our case study is too specific to globalPlatform2 | Low | Medium | Abstract patterns, keep implementation details in a clearly labeled section |
...
### T5: Write guide — Case Study: globalPlatform2 Flywheel (P1, 30 min)
- Depends on: T3a
